 ...
 */
class Google_AdSense_Async_ACM_Provider extends ACM_Provider {
	...
	public function __construct() {
		// Default output HTML
		$this->output_html ='<div id="acm-ad-tag-%tag%"><script asyn c src="http://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
...
/**
 * Google AdSense Async list table for Ad Code Manager
 */
class Google_AdSense_Async_ACM_WP_List_Table extends ACM_WP_List_Table {
	/**
	...
	public function __construct() {
		parent::__construct( array(
				'singular'=> 'google_adsense_async_acm_wp_list_table',
				'plural' => 'google_adsense_async_acm_wp_list_table',
				'ajax' => true
			) );
	}
