...
?>
					<option value="<?php echo esc_attr( $key ); ?>" <?php selected( $key, $zone ); ?>><?php echo esc_attr( $key ); ?></option>
					<?php
		}
?>
			</select>
			...
			<span class="description"><?php echo esc_textarea( sprintf( __( "No ad codes have been added yet. <a href='%s'>Please create one</a>.", 'ad-code-manager' ), $create_url ) ); ?></span>
			<?php endif; ?>
			</p>
